...
class SerializacaoNFSeTest:
    ...
    def get_notafiscal_servico() -> NotaFiscalServico:
        servico = Servico(
            ...
            codigo_municipio=obter_codigo_por_municipio("Pedro Leopoldo", "MG"),
            # Dados opcionais
            codigo_cnae=6201501,
    ...
    def _get_config() -> SerializacaoNFSeConfigTest:
        return SerializacaoNFSeConfigTest("./tests/certificado.pfx", bytes("123456", "utf-8"), True)

    @staticmethod
    def _get_emitente() -> Emitente:
        return Emitente(cnpj="45111111111100", inscricao_municipal="000000")
